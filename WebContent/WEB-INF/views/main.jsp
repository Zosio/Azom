    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#manager-set").click(function() {
                $("#frame-id").attr("src", "${pageContext.request.contextPath}/backend/sysuser/list");
            });
        });
            ...
            <div class="row user-setting">
                <div class="col-xs-2 user-wrap">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item active" name="adminSet" id="manager-set">
                            <i class="glyphicon glyphicon-globe"></i> &nbsp;系统用户管理
                        </li>
                    </ul>
                </div>
                <div class="col-xs-10" id="userPanel">
                    <iframe id="frame-id" src="${pageContext.request.contextPath}/backend/sysuser/list" width="100%" height="100%" frameborder="0" scrolling="no">
                    </iframe>
                </div>
